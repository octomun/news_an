...
data = stock_setting.fetch_all(conn)
stock = pd.DataFrame(data)

if stock_setting.fetch_all_pro(conn):
...
# print(stock)
# for i in range(len(stock)):
#     stock_setting.insert_tabel_pro(stock['dates'][i],stock['times'][i], stock['opens'][i],
#                                    stock['highs'][i],  stock['lows'][i],  stock['closes'][i],
#                                    stock['vols'][i], stock['date_time'][i],  stock['5days_rolling'][i],
#                                    stock['5days_rolling'][i],  stock['max_min'][i],
#                                    stock['pct'][i],  stock['week_day'][i],  stock['month'][i], conn
#     )
